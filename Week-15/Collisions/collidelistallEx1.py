...
def main():
    ...
    list4 = [redRect, blueRect, yellowRect]

    print(redRect.collidelistall(list1))
    print(yellowRect.collidelistall(list3))
    print(yellowRect.collidelistall(list2))
    print(greenRect.collidelistall(list4))
